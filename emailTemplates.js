...
const register = (user, token) => {
	...
	const htmlStr = '<img src="https://bento-box-2-df32a7e90651.herokuapp.com/static/media/BB_Logo_Horizontal_COLOR_1.7df173123f6a37adc674.png" height="80"><h2>Ready to Unbox the World of Anime?</h2><p>Welcome to Bento Box! You are receiving this email because you recently created an account with us.</p><p>Please verify your account by clicking the link below:</p>';
...
const resetPassword = (user, token) => {
	...
	const htmlStr = '<img src="https://bento-box-2-df32a7e90651.herokuapp.com/static/media/BB_Logo_Horizontal_COLOR_1.7df173123f6a37adc674.png" height="80"><h2>Reset Your Password</h2><p>You have requested to reset your password for Bento Box.</p><p>To reset your password, please click the following link:</p>';
	const tokenURI = encodeURIComponent(token);
